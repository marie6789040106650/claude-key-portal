...
3. [PROJECT_CORE_DOCS/](./PROJECT_CORE_DOCS/) - 核心文档目录
   ...
   - [03\_发展路线图.md](./PROJECT_CORE_DOCS/03_发展路线图.md) - 开发计划
...
👉 **README.md** → **PROJECT*CORE_DOCS/01*项目背景.md**
...
👉 **PROJECT*CORE_DOCS/02*功能需求和边界.md**

### 我想了解开发计划

👉 **PROJECT*CORE_DOCS/03*发展路线图.md**
...
| PROJECT*CORE_DOCS/01*项目背景.md       | 项目背景      | P0     |
| PROJECT*CORE_DOCS/02*功能需求和边界.md | 功能需求      | P0     |
| PROJECT*CORE_DOCS/03*发展路线图.md     | 路线图        | P0     |
